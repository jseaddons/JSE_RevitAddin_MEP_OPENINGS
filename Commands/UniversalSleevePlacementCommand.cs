...
namespace JSE_RevitAddin_MEP_OPENINGS.Commands
{
    ...
    public class UniversalSleevePlacementCommand : ICommand
    {
        ...
        public UniversalSleevePlacementCommand(
            ...
            SizingSettings? sizingSettings = null,
            ...
            ISectionBoxChecker? sectionBoxChecker = null)
        {
            ...
            // ✅ NEW: Apply UI sizing settings to loaded conditions
            if (sizingSettings != null && _conditions != null)
            {
                _conditions.SizingSettings = sizingSettings;
                DebugLogger.Info($"{_logPrefix} Updated conditions with UI sizing settings: Rounding={sizingSettings.EnableRounding}, Increment={sizingSettings.RoundingIncrementMm}mm, Threshold={sizingSettings.CircularToRectangularThresholdMm}mm");
            }
