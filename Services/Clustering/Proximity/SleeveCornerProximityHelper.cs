    ...
    public class SleeveCornerProximityHelper
    {
        ...
        public bool AreWithinProximity(ClashZone cz1, ClashZone cz2, double toleranceDist)
        {
            ...
            try
            {
                ...
                var min1X = bbox1.minX - toleranceDist;
                var max1X = bbox1.maxX + toleranceDist;
                var min1Y = bbox1.minY - toleranceDist;
                var max1Y = bbox1.maxY + toleranceDist;
                var min1Z = bbox1.minZ - toleranceDist;
                var max1Z = bbox1.maxZ + toleranceDist;
