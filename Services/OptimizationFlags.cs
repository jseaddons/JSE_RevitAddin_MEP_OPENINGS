...
namespace JSE_RevitAddin_MEP_OPENINGS.Services
{
    ...
    public static class OptimizationFlags
    {
        ...
        /// </summary>
        public static bool DisableVerboseLogging { get; set; } = true; // ✅ OPTIMIZED: Silences verbose logging for performance
        ...
        /// <summary>
        /// ✅ PERFORMANCE OPTIMIZATION: Use pre-calculated dimensions from database cache
        /// When true: Uses CalculatedSleeveWidth/Height/Diameter from ClashZones table (populated during calculation)
        /// When false: Recalculates dimensions at placement time (legacy behavior)
        /// Default: true (enabled - saves ~23ms per sleeve by eliminating clearance lookup + rounding)
        /// Expected gain: 87% reduction in dimension calculation time (26ms → 3ms)
        /// Location: Services/NewSleevePlacerService.cs (CalculateSleeveDimensions)
        /// </summary>
        public static bool UseDimensionCache { get; set; } = true;
        ...
        #region Phase 1 & 2 New Optimization Flags
        
        /// <summary>
        /// Enable global caching for frequently accessed elements (Levels, Families, etc.)
        /// Default: true (Performance optimization)
        /// </summary>
        public static bool UseGlobalCaching { get; set; } = true;

        /// <summary>
        /// Enable caching for corner placement calculations
        /// Default: true (Performance optimization)
        /// </summary>
        public static bool UseCornerPlacementCache { get; set; } = true;

        /// <summary>
        /// Enable global level cache to avoid repeated filtered element collectors
        /// Default: true (Performance optimization)
        /// </summary>
        public static bool UseGlobalLevelCache { get; set; } = true;
...
Clustering Flags: GeometricCenterWalls={UseGeometricCenterForWalls}, GeometricCenterFloors={UseGeometricCenterForFloors}";
        }
        ...
        /// <summary>
        /// Enable Geometric Center calculation for WALL clustering.
        /// Fixes lateral shifts in rotated wall clusters when sleeves are unbalanced.
        /// Default: false (safety flag per user request)
        /// </summary>
        public static bool UseGeometricCenterForWalls { get; set; } = false;

        /// <summary>
        /// Enable Geometric Center calculation for FLOOR clustering.
        /// Fixes lateral shifts in floor clusters (centroid vs extremes discrepancy).
        /// Default: true (enabled per user request to fix floor shifts)
        /// </summary>
