...
*   **Limits Section:**
    ...
    *   `round_to_rectangular_if_diameter_greater_than`: This setting should only be applied to round pipes and round ducts. For other MEP elements, this setting should be ignored.
